...
help:
	...
	@echo ""
	@echo "- IMG_SIZE"
	@echo "Change the image size of the image to generate."
	@echo ""
	@echo "- PKG_MANAGER"
	@echo "Specify the path to dnf or yum."
	@echo ""
	@echo "- USE_DOCKER"
	@echo "Use a docker container to build an image (useful when depedencies are not installed)."
	@echo ""
	@echo "Targets:"
	@echo ""
